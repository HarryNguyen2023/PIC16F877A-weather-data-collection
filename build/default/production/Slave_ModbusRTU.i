...
# 2 "<built-in>" 2
# 1 "Slave_ModbusRTU.c" 2
# 1 "./Slave_ModbusRTU.h" 1
...
# 5 "./Slave_ModbusRTU.h" 2
# 23 "./Slave_ModbusRTU.h"
...
void Slave_SendData(int temp, uint16_t humid_frq, uint8_t function){
    ...
    if(function == (uint8_t)0x33){

        ModbusFrame[0] = (uint8_t)0x31;
